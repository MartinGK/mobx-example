...
const backgrounds = {
    ...
    blue: "bg-[repeating-linear-gradient(-45deg,#9FD8EF,#9FD8EF_2px,#ffffff_2px,#ffffff_5px)]",
    green: "bg-[repeating-linear-gradient(-45deg,#9AD349,#9AD349_2px,#ffffff_2px,#ffffff_5px)]",
    red: "bg-[repeating-linear-gradient(-45deg,#FDADAD,#FDADAD_2px,#ffffff_2px,#ffffff_5px)]"
}
